...
describe("Chunk 3 protected review record", () => {
  it("requires typed disposition, source evidence, evidence changes, and rationale", () => {
    ...
    expect(matchingReviewRequestSchema.safeParse({ ...valid, correctedListingText: undefined }).success).toBe(false);
  ...
  it("builds deterministic evidence links with reviewer, time, and rules version", () => {
    ...
    expect(buildMatchingReviewDecision(parsed, "reviewer", "2026-09-05T00:00:00.000Z", { correctedJobSnapshotId: "83000000-0000-4000-8000-000000000002", correctedInventoryVersionId: "72000000-0000-4000-8000-000000000002", correctedInventoryMemberId: "82000000-0000-4000-8000-000000000002" })).toMatchObject({ disposition: "RESOLVED_PASS", sourceEvidenceNodeIds: [valid.sourceEvidenceNodeIds[0]], candidateFactIds: [], evidenceChanges: valid.evidenceChanges, rulesVersion: "matching-rules-v3", reviewerId: "reviewer", resolvedAt: "2026-09-05T00:00:00.000Z", correctedJobSnapshotId: "83000000-0000-4000-8000-000000000002" });
  });
});
