...
describe("rendered document text normalization", () => {
  it("ignores automatic bullet markers at the start of rendered lines", () => {
    expect(normalizeRenderedDocumentText("Heading\n \u2022 First item\n\u2022 Second item\n \uFFFD Third item"))
      .toBe("Heading First item Second item Third item");
  });

  it("preserves inline and content-owned bullets", () => {
    expect(normalizeRenderedDocumentText("Budget \u2022 finance and \uFFFD replacement\n \u2022 \u2022 literal bullet"))
      .toBe("Budget \u2022 finance and \uFFFD replacement \u2022 literal bullet");
  });
});
