    ...
    <main id="main-content" className="brief-page">
      ...
      <section className="brief-page-body">
        <div className="page-frame">
          ...
          {page.slug === "pricing" ? <><PricingCards /><div className="brief-price-examples"><span>Board: <strong>from $6.99</strong></span><span>Top 10: <strong>$20</strong></span><span>Top 10 plus one package: <strong>$28 total</strong></span><span>Each document pair: <strong>$8</strong></span></div><ul className="brief-reassurance-row"><li><Check aria-hidden="true" />No subscription required for Top 10</li><li><Check aria-hidden="true" />No free trial on board plans</li><li><Check aria-hidden="true" />No automatic applications</li><li><Check aria-hidden="true" />No obligation to buy document sets</li></ul></> : null}
