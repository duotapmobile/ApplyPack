...
export type SourceAdapterKind = "lever" | "greenhouse" | "ashby" | "recruitee" | "teamtailor" | "official_link_only" | "existing_import";
...
export type AtsPlatform = "lever" | "greenhouse" | "ashby" | "recruitee" | "teamtailor" | "workday" | "custom" | "unknown" | "none";
...
export type SourceDefinition = {
  ...
  /** Runtime-only allowlist copied from the immutable database authorization. */
  authorizationAllowedHosts?: readonly string[];
...
export type RawJobPosting = {
  rawSourceEvidence?: import("./raw-source-evidence").RawSourceEvidence;
  sourceId: string;
