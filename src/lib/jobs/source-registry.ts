...
const direct = (
  ...
  atsPlatform: "unknown",
  accessMethod: "manual_official_career_page",
  refreshSchedule: null,
  scheduleEnabled: false,
  ingestionPermissionStatus: "manual_research_only",
  paidDisplayPermissionStatus: "direct_link_only",
  permissionEvidenceUrl: officialUrl,
...
export const jobSources: readonly SourceDefinition[] = [
  ...
  direct("stride", "Stride Inc.", "core_direct_employer", "https://www.stridelearning.com/careers/", 100, {
    alternateOfficialUrls: ["https://strideinc.wd1.myworkdayjobs.com/SK"], atsPlatform: "workday", atsTenantIdentifier: "strideinc/SK",
  ...
  direct("duolingo", "Duolingo", "selective_broad_employer", "https://careers.duolingo.com/", 75, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/duolingo/"], adapterKind: "greenhouse", adapterKey: "duolingo",
    atsPlatform: "greenhouse", atsTenantIdentifier: "duolingo", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; not scheduled or persisted until reviewed activation.",
  }),
  direct("ultimate-medical-academy", "Ultimate Medical Academy", "selective_broad_employer", "https://workatuma.com/", 75, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/umaeducationinc/"], adapterKind: "greenhouse", adapterKey: "umaeducationinc",
    atsPlatform: "greenhouse", atsTenantIdentifier: "umaeducationinc", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; not scheduled or persisted until reviewed activation.",
  }),
  direct("brightwheel", "Brightwheel", "selective_broad_employer", "https://mybrightwheel.com/careers/", 75, {
    alternateOfficialUrls: ["https://jobs.ashbyhq.com/brightwheel"], adapterKind: "ashby", adapterKey: "brightwheel",
    atsPlatform: "ashby", atsTenantIdentifier: "brightwheel", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.ashbyhq.com/docs/public-job-posting-api",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; not scheduled or persisted until reviewed activation.",
  }),
  direct("classdojo", "ClassDojo", "selective_broad_employer", "https://www.classdojo.com/jobs/", 75, {
    atsPlatform: "unknown", atsTenantIdentifier: "unknown", notes: "Requested employer batch. Official page verified; no supported public ATS tenant was identified.",
  }),
  direct("capella-university", "Capella University", "selective_broad_employer", "https://www.capella.edu/careers/", 75, {
    alternateOfficialUrls: ["https://strayer.wd1.myworkdayjobs.com/CU_Careers"], atsPlatform: "workday", atsTenantIdentifier: "strayer/CU_Careers",
    notes: "Requested employer batch. Workday tenant verified; no Workday adapter is implemented.",
  }),
  direct("outschool", "Outschool", "selective_broad_employer", "https://outschool.com/careers", 75, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/outschool/"], adapterKind: "greenhouse", adapterKey: "outschool",
    atsPlatform: "greenhouse", atsTenantIdentifier: "outschool", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; not scheduled or persisted until reviewed activation.",
  }),
  direct("stripe", "Stripe", "selective_broad_employer", "https://stripe.com/careers/search", 55, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/stripe/"], adapterKind: "greenhouse", adapterKey: "stripe",
    atsPlatform: "greenhouse", atsTenantIdentifier: "stripe", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; specialized roles require relevance filtering; not scheduled.",
  }),
  direct("block", "Block", "selective_broad_employer", "https://block.xyz/careers/jobs", 55, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/block/"], adapterKind: "greenhouse", adapterKey: "block",
    atsPlatform: "greenhouse", atsTenantIdentifier: "block", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; specialized roles require relevance filtering; not scheduled.",
  }),
  direct("coinbase", "Coinbase", "selective_broad_employer", "https://www.coinbase.com/careers/positions?location=all", 55, {
    alternateOfficialUrls: ["https://job-boards.greenhouse.io/coinbase/"], adapterKind: "greenhouse", adapterKey: "coinbase",
    atsPlatform: "greenhouse", atsTenantIdentifier: "coinbase", accessMethod: "public_structured_endpoint", automationStatus: "automated",
    ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://developers.greenhouse.io/job-board.html",
    notes: "Requested employer batch. Bounded endpoint test passed 2026-09-08; specialized roles require relevance filtering; not scheduled.",
  }),
  ...
  direct("vipdesk-connect", "VIPdesk Connect", "contractor_staffing_flexible", "https://jobs.lever.co/vipdesk", 30, { adapterKind: "lever", adapterKey: "vipdesk", atsPlatform: "lever", atsTenantIdentifier: "vipdesk", accessMethod: "public_structured_endpoint", automationStatus: "automated", ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://github.com/lever/postings-api", defaultWorkerRelationship: "unknown", defaultEmploymentType: "unknown", defaultBenefitsStatus: "varies" }),
  ...
  direct("five-star-call-centers", "Five Star Call Centers", "contractor_staffing_flexible", "https://jobs.lever.co/getfivestar", 30, { adapterKind: "lever", adapterKey: "getfivestar", atsPlatform: "lever", atsTenantIdentifier: "getfivestar", accessMethod: "public_structured_endpoint", automationStatus: "automated", ingestionPermissionStatus: "approved_public_endpoint", permissionEvidenceUrl: "https://github.com/lever/postings-api", defaultWorkerRelationship: "unknown", defaultEmploymentType: "unknown", defaultBenefitsStatus: "unknown" }),
  ...
  {
    id: "edtech-com-fully-remote",
    canonicalEmployerId: null,
    employerDisplayName: null,
    sourceName: "EdTech.com Fully Remote Jobs",
    category: "third_party_aggregator",
    officialUrl: "https://www.edtech.com/jobs/fully-remote-jobs",
    adapterKind: "official_link_only",
    authorizationStatus: "BLOCKED",
    authorizationEvidenceId: null,
    authorizationVersion: "source-auth-v1",
    atsPlatform: "none",
    atsTenantIdentifier: "none",
    ...
    permissionEvidenceUrl: "https://www.edtech.com/terms",
    isOfficial: false,
    isDirectEmployer: false,
    isActive: false,
    priority: 70,
    notes: "Evaluated 2026-09-08. The page returned HTTP 403 to the audit client and no ingestion or paid-display license was established. Do not ingest or display until written permission or a licensed feed is recorded.",
  },
];
