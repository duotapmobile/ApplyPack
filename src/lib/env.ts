...
const serverSchema = z.object({
  ...
  APP_DOCUMENT_RENDERER_IDENTITY: z.string().optional(),
  APP_LIBREOFFICE_EXECUTABLE: z.string().optional(),
  APP_LIBREOFFICE_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_PDFINFO_EXECUTABLE: z.string().optional(),
  APP_PDFINFO_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_PDFFONTS_EXECUTABLE: z.string().optional(),
  APP_PDFFONTS_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_PDFTOTEXT_EXECUTABLE: z.string().optional(),
  APP_PDFTOTEXT_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_PDFTOPPM_EXECUTABLE: z.string().optional(),
  APP_PDFTOPPM_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_ARIAL_FONT_FILE: z.string().optional(),
  APP_ARIAL_FONT_FILE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
