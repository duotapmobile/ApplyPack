...
const serverSchema = z.object({
  ...
  APP_DOCUMENT_FONT_FILE: z.string().optional(),
  APP_DOCUMENT_FONT_FILE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  APP_DOCUMENT_FONT_FAMILY: z.enum(["Arial", "Liberation Sans"]).optional(),
  APP_PYMUPDF_PYTHON_EXECUTABLE: z.string().optional(),
  APP_PYMUPDF_PYTHON_EXECUTABLE_SHA256: z.string().regex(/^[0-9a-f]{64}$/i).optional().or(z.literal("")),
  ...
  APP_KMS_PROVIDER: z.enum(["remote", "aws"]).default("remote"),
