export const siteConfig = {
  ...
  publicRoutes: ["/", "/job-board", "/why-apply-pack", "/how-it-works", "/job-search-help", "/experience-connections", "/before-and-after", "/why-customize", "/resume-screening", "/not-just-ai", "/pricing", "/faq", "/about", "/contact", "/accessibility", "/privacy", "/terms"],
} as const;
