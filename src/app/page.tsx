      ...
      <section className="brief-hero" aria-labelledby="home-title">
        <div className="page-frame brief-hero-grid">
          <div className="brief-hero-copy">
            ...
            <p className="brief-hero-lede">You may be qualified for more roles than you realize. ApplyPack finds 10 current jobs that fit both what you can do and what your life requires, for $20, delivered within 24 hours after intake, payment, and capacity confirmation.</p>
            ...
            <p className="brief-reassurance">The $20 Top 10 requires no subscription. You choose where to apply.</p>
