...
export default async function AdminPage() {
  ...
  const stagingBoardReviewJobs = process.env.APP_STAGING_SYNTHETIC_JOBS === "true" && process.env.APP_PAYMENT_MODE !== "live"
    ? await loadSyntheticBoardReviewJobs(admin).catch(() => []) : [];
